...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PAGE_LIST_ISNULL(false,31007,"分页查询课程失败，为空！"),
    ...
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31109,"媒资文件对应的教学计划为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31110,"媒资文件对应的教学计划的等级不是3！"),
    COURSE_TEACHPLANISNULL(false,31106,"课程计划为空！"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31108,"创建课程索引信息失败！"),
    COURSE_MEDIA_LISTISNULL(false,31111,"查询的媒资列表为空！"),
    COURSE_MEDIA_DELETEFAIL(false,31112,"媒资列表删除失败！"),
